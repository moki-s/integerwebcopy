        ...
        <div style="background: #FFFDF7; padding: 2rem; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1); text-align: left; border: 1px solid #f0e6d2;">
            ...
            <form action="/enquiry" method="POST">
                ...
                <div style="margin-bottom: 1rem;">
                    ...
                    <input id="product-name" name="name" class="contact-input" type="text" placeholder="Your Name*" required style="width:100%;padding:0.85rem;border:1px solid #eaeaea;border-radius:4px;background:white;font-family:var(--font-body);">
                </div>
                <div style="margin-bottom: 1rem;">
                    <label class="contact-form-label" for="product-email">Email <span style="color:var(--color-error-red);">*</span></label>
                    <input id="product-email" name="email" class="contact-input" type="email" placeholder="Email*" required style="width:100%;padding:0.85rem;border:1px solid #eaeaea;border-radius:4px;background:white;font-family:var(--font-body);">
                </div>
                <div style="margin-bottom: 1rem;">
                    <label class="contact-form-label" for="product-phone">Phone <span style="color:var(--color-error-red);">*</span></label>
                    <input id="product-phone" name="phone" class="contact-input" type="tel" placeholder="Phone No*" required style="width:100%;padding:0.85rem;border:1px solid #eaeaea;border-radius:4px;background:white;font-family:var(--font-body);">
                </div>
                <div style="margin-bottom: 1.25rem;">
                    <label class="contact-form-label" for="product-course">Course Interest</label>
                    <input id="product-course" name="course_interest" class="contact-input" type="text" value="<?php echo htmlspecialchars($course['title']); ?>" style="width:100%;padding:0.85rem;border:1px solid #eaeaea;border-radius:4px;background:white;font-family:var(--font-body);">
                </div>
